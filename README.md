...
>```
>
>3.2.1 Run with Vitis Classic IDE w/ GUI:
>- Open Xilinx Vitis
...
>
>3.2.2 Run with Vitis Unified IDE w/ Scripts:
>```bash
># Open Xilinx Vitis (2025.2) xsct console, cd into deepsocflow, and run the following:
>cd run/work
>
># Only needs to be re-run if the hardware design or source changes.
>source ../../deepsocflow/tcl/fpga/vitis_build.tcl
>
># Connect board and run:
>source ../../deepsocflow/tcl/fpga/vitis_run.tcl
>```
</details>
